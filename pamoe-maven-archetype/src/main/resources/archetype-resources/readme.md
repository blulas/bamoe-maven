...
This repository contains the `${projectName} micro-process service`, packaged as a `Quarkus Microservice JAR)`, and was originally generated by the `IBM Process Automation Manager Open Edition Maven Archetype` in order to ensure compliancee with Maven best practices. 
